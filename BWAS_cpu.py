    ...
    if ind_sig_mat.shape[0]==0:
        ...
        if np.sum(result_table[:,1]<0.05)>0:
            ...
            for i in range(0,len(infos)):
                ...
                fig.savefig(result_dir+'1.png',dpi=512)

                img1 = np.array(misc.imread(result_dir+'1.png'),dtype='uint8')
                ...
                img2 = np.array(misc.imread(result_dir+'1.png'),dtype='uint8')
            ...
            #misc.imsave(result_dir+'BWAS_FC_clusters_plot.png',image_final)
